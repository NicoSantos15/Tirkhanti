...
namespace Tirkhanti_R12.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        private readonly SignInManager<Tirkhanti_R12Users> _signInManager;
        ...
        public RegisterModel(
            ...
            SignInManager<Tirkhanti_R12Users> signInManager,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new Tirkhanti_R12Users { UserName = Input.Id, FirstName = Input.FirstName, LastName = Input.LastName };
